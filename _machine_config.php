...
GlobalConfig::$CONNECTION_SETTING->DBName = "eventos";
...
/** the root url of the application with trailing slash, for example http://localhost/eventos/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'eventos/';
