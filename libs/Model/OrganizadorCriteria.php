...
require_once("DAO/OrganizadorCriteriaDAO.php");

/**
 * The OrganizadorCriteria class extends OrganizadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class OrganizadorCriteria extends OrganizadorCriteriaDAO
{
