...
class EventoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Nome,Descricao,Organizador,Dataevento'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$evento->Descricao = $this->SafeGetVal($json, 'descricao');
			$evento->Organizador = $this->SafeGetVal($json, 'organizador');
			$evento->Dataevento = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'dataevento')));
	...
	public function Update()
	{
		try
		{
			...
			$evento->Descricao = $this->SafeGetVal($json, 'descricao', $evento->Descricao);
			$evento->Organizador = $this->SafeGetVal($json, 'organizador', $evento->Organizador);
			$evento->Dataevento = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'dataevento', $evento->Dataevento)));
