/**
 * backbone model definitions for EVENTOS
 */
...
/**
 * Organizador Backbone Model
 */
model.OrganizadorModel = Backbone.Model.extend({
	urlRoot: 'api/organizador',
	idAttribute: 'id',
	id: '',
	nome: '',
	defaults: {
...
/**
 * Organizador Backbone Collection
 */
model.OrganizadorCollection = model.AbstractCollection.extend({
	url: 'api/organizadors',
	model: model.OrganizadorModel
});
